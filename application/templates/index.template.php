      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-minus-circle">&nbsp;</i>Opérations<span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                  <li><a href="#" class='btn-link'>Editer une FM</a></li>
                  <li><a href="#" class='btn-link'>Editer une CRE</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li>email:</li>
                <li class="divider"></li>
                <li class="dropdown-header">Cordonnateur de:</li>
                <li>Responsable de:</li>
                <li class="btn-warning col-lg-10 col-lg-offset-1"><a href="#">Deconnexion</a></li>
              </ul>
            </li>
          </ul>
